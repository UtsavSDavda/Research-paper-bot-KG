...
#NODES: p:Paper, a:Author, k:Keyword, c:Concept, t:Topic, j:Journal, h:Host
#RELATIONSHIPS: p-RELATED_TO->p,p-HAS_KEYWORD->k,p-PUBLISHED_IN->j,p-HOSTED_BY->h,a-FIRST_AUTHORED->p,p-COVERS->t,p-DISCUSSES->cfrom dotenv import load_dotenv
import os
from neo4j import GraphDatabase
